About xstatic-bootstrap-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xstatic-bootstrap-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10939&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xstatic-bootstrap-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xstatic-bootstrap` can be installed with `conda`:
...
```
mamba install xstatic-bootstrap
```

It is possible to list all of the versions of `xstatic-bootstrap` available on your platform with `conda`:
...
```
mamba search xstatic-bootstrap --channel conda-forge
```
...
mamba repoquery search xstatic-bootstrap --channel conda-forge

# List packages depending on `xstatic-bootstrap`:
mamba repoquery whoneeds xstatic-bootstrap --channel conda-forge

# List dependencies of `xstatic-bootstrap`:
mamba repoquery depends xstatic-bootstrap --channel conda-forge
```
